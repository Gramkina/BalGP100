...
<html>
	<head>
		<title>Личный кабинет - Мои устройства</title>
	...
	<!--         PATH           -->
	<div class="path mediumTextBlue"><span><a href="/">Главная</a> • <a href="/profile">Личный кабинет</a> • <a href="/profile/devices.php">Мои устройства</a></span></div>
...
<script>
	window.onload = function(){
		$.get('templates/devices.php', function(result){
